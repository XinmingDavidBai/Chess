...
public class Knight : IPiece  {
    ...
    public Knight (playerColor newColor, (char,int) position) {
        Color = newColor;
        ...
        {
            playerColor.White => "knight_white",
            playerColor.Black => "knight_black",
            _ => Label
    ...
    public PieceType Type { get; } = PieceType.Knight;
